...
// if (!invoke.getTargetMethod().getDeclaringClass().getName().startsWith("Ljava") &&
// !invoke.getTargetMethod().getDeclaringClass().getName().startsWith("Lsun") &&
// !invoke.getTargetMethod().getDeclaringClass().getName().startsWith("Ljdk"))
        o1.incMultiInline();
// }
// counter3++;
// System.out.println(" MultitypeGuard Inline is called : " +
// invoke().getTargetMethod().getDeclaringClass().getName() + "." +
...
// System.out.println("1. Graph in multitype : ");
// }
// if (!invoke.getTargetMethod().getDeclaringClass().getName().startsWith("Ljava") &&
// !invoke.getTargetMethod().getDeclaringClass().getName().startsWith("Lsun") &&
// !invoke.getTargetMethod().getDeclaringClass().getName().startsWith("Ljdk")) {
        if (numberOfMethods == 2) {
            // bimorph++;
            o1.incBimorph();
            // System.out.println("Bimorphic call");
        } else {
            // polymorph++;
            o1.incPolymorph();
            // System.out.println("Polymorphic call (" + numberOfMethods + ")");
        }
// }
...
// if (invoke.callTarget().targetMethod().getName().equals("bar")) {
// System.out.println("2. Graph in multitype : " + replacementNodes);
// }

...
import org.graalvm.compiler.phases.common.inlining.info.MyDebug;
...
// if (invoke.callTarget().targetMethod().getName().equals("bar")) {
// System.out.println("******** 1. Reason for not Inlining ************ :" + failureMessage);
// }
            return null;
        }
...
// if (invoke.callTarget().targetMethod().getName().equals("bar")) {
// System.out.println("******** Instance of Object stamp ***********");
// }
            return null;
        }
...
// if (targetMethod.getName().equals("bar")) {
// System.out.println("******** 1. Method bar is called ************");
// }
...
// if (targetMethod.getName().equals("bar")) {
// System.out.println("******** 2. Type Profile is null ***********");
// }
...
// if (targetMethod.getName().equals("bar")) {
// System.out.println("******** 3. ptypes is null ************");
// }
        ...
        // A: Informations from Profile data

        ResolvedJavaType contextType = invoke.getContextType(); // A: context type -- the class
        ...
        // A: Check if speculation can be performed based on profile data.
        ...
        // A: Check for monomorphic case based on profile
        ...
        if (ptypes.length == 1 && notRecordedTypeProbability == 0 && !speculationFailed) {
            ...
            return new TypeGuardInlineInfo(invoke, concrete, type, speculation); // A: Guarantee
                                                                                 // that only one
                                                                                 // receiver type is
                                                                                 // there.
        } else {
    ...
    private void processNextInvoke() {
        ...
        if (invoke.callTarget().targetMethod().getName().equals("bar")) {
            System.out.println("******** Bar Method reached at processNextinvoke ************");
            System.out.println("Info details: " + info.getClass().toString());
        }
        if (info != null) {
...
// if (invoke.callTarget().targetMethod().getName().equals("bar")) {
// System.out.println("********1. moveForward is called ************");
// }
        if (backtrack) {
...
// if (invoke.callTarget().targetMethod().getName().equals("bar")) {
// System.out.println("******** 2. moveForward is called ************");
// }
...
// try {
// if (invoke.callTarget().targetMethod().getName().equals("bar")) {
// System.out.println("****** 3. After processInvoke************");
// }
...
// }
// } else {
// System.out.println("invoke.calltarget is null");
// }
// } else {
...
// if (invoke.callTarget().targetMethod().getName().equals("bar")) {
// System.out.println("****** 4. After processInvoke************");
// }
// try to inline
